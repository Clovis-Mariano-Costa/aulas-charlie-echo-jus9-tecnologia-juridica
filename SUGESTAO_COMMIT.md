...
```txt
feat: criar portal de aulas públicas da Charlie Echo
```

## Description

```txt
Consolida o repertório aulas-charlie-echo-jus9 no Mão na Massa Final da Jus 9, com padrão visual obrigatório, modelo de assinatura com ©, orientações de leitura obrigatória, segurança, classificação de conteúdo e instruções para futuras alterações.
